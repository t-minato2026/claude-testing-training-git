...
// FaRSeT(Bug#11): 不具合実装に伴い、このimport文は未使用となるためコメントアウト
...
public class MemberUpdateController {
    ...
    public String update(@Validated MemberUpdateForm memberUpdateForm,
         ...
         *
         * @bug_id        11
         * @bug_title     セッション情報不整合
         * @author        Sota Toyama
         * @see           「FaRSeTトレーニング用のATRSのサンプル不具合の案」
         *
         * @purpose
         * - システムの『内部データ(DB)』と『表示状態(UI)』が常に同期していることの重要性を学習させます。
         * - 状態変更が、関連する全てのコンポーネントに正しく伝播しているかを確認するテストの価値を理解します。
         *
         * @modification
         * - DBの会員情報更新後に、セッションに格納されているログインユーザー情報(AtrsUserDetails)を更新する処理をコメントアウトしました。
         *
         * @impact
         * - 会員情報変更画面で名前などを更新しても、画面ヘッダに表示されている「ようこそ、〇〇さん」の名前が古いままになります。
         *
         * @revert
         * - このFaRSeTコメントブロックと直下のBUGGY CODEのコメントアウト(/*と*&#47;)を解除してください。
         *
         ****************************************************************/
        /* --- BUGGY CODE ---
