...
<link rel="stylesheet"
    href="${pageContext.request.contextPath}/resources/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css">
<link rel="stylesheet"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form:form id="membership-form" cssClass="form-horizontal"
                            action="${pageContext.request.contextPath}/member/register?confirm"
                            method="post" modelAttribute="memberRegisterForm">
                            <div class="form-group">
                                <form:label path="kanjiFamilyName"
                                    cssClass="col-md-4 control-label">氏名</form:label>
                                <div class="col-md-8">
                                    <div class="input-group inline-half">
                                        <form:label path="kanjiFamilyName"
                                            cssClass="input-group-addon">姓</form:label>
                                        <%--
                                        /****************************************************************
                                         * ■■■ FaRSeT トレーニング用不具合実装 START ■■■
                                         *
                                         * @bug_id        5
                                         * @bug_title     必須項目の入力漏れ (クライアントサイド)
                                         * @author        Sota Toyama
                                         * @see           「FaRSeTトレーニング用のATRSのサンプル不具合の案」
                                         *
                                         * @purpose
                                         * - 「氏名(姓)」のクライアントサイドの必須チェックを意図的に無効化する。
                                         *
                                         * @modification
                                         * - data-parsley-required="true" 及び関連メッセージ属性を削除。
                                         *
                                         ****************************************************************/
                                        --%>
                                        <%--
                                        ...
                                        --%>
                                        <form:input path="kanjiFamilyName" cssClass="form-control"
                                            maxlength="10" data-parsley-maxlength="10"
                                            data-parsley-maxlength-message="姓は %s 文字以下で入力してください。" />
                                    </div>
                                    <div class="input-group inline-half">
                                        <form:label path="kanjiGivenName"
                                            cssClass="input-group-addon">名</form:label>
                                        <form:input path="kanjiGivenName" cssClass="form-control"
                                            maxlength="10" data-parsley-maxlength="10"
                                    ...
                                    <form:errors path="kanjiFamilyName" cssClass="invalid"
                                        element="span" />
                                    <form:errors path="kanjiGivenName" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>

                            <div class="form-group">
                                <form:label path="kanaFamilyName"
                                    cssClass="col-md-4 control-label">氏名(カタカナ)</form:label>
                                <div class="col-md-8">
                                    <div class="input-group inline-half">
                                        <form:label path="kanaFamilyName"
                                            cssClass="input-group-addon">セイ</form:label>
                                        <form:input path="kanaFamilyName" cssClass="form-control"
                                            maxlength="10" data-parsley-maxlength="10"
                                    ...
                                    <div class="input-group inline-half">
                                        <form:label path="kanaGivenName"
                                            cssClass="input-group-addon">メイ</form:label>
                                        <form:input path="kanaGivenName" cssClass="form-control"
                                            maxlength="10" data-parsley-maxlength="10"
                                    ...
                                    <div class="clearfix"></div>
                                    <form:errors path="kanaFamilyName" cssClass="invalid"
                                        element="span" />
                                    <form:errors path="kanaGivenName" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                                ...
                                <div class="col-md-8 form-inline">
                                    <c:forEach var="item" items="${CL_GENDER}">
                                        <label class="radio-inline"> <form:radiobutton
                                                path="gender" value="${f:h(item.key)}"
                                                data-parsley-required="true" />${f:h(CL_GENDER[item.key])}
                                        </label>
                                    </c:forEach>
                                    <div class="clearfix"></div>
                                    <form:errors path="gender" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <form:label path="dateOfBirth"
                                    cssClass="col-md-4 control-label">生年月日</form:label>
                                <div class="col-md-8">
                                    <form:input path="dateOfBirth" cssClass="form-control"
                                        ...
                                        data-date-language="ja" data-parsley-required="true"
                                        data-parsley-date="true" />
                                    <form:errors path="dateOfBirth" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
 ...
 *
 * @bug_id        18
 * @bug_title     [代替案] UIの不整合
 * @author        Sota Toyama
 * @see           「FaRSeTトレーニング用のATRSのサンプル不具合の案」
 *
 * @purpose
 * - UIの視覚的な美しさやレイアウトの一貫性が、いかにユーザーの快適な操作性に影響するかを学習させます。
 *
 * @modification
 * - 「電話番号」行のレイアウトを意図的に崩すため、ラベル部分のカラム幅を`col-md-4`から`col-md-3`に、入力欄部分のカラム幅を`col-md-8`から`col-md-9`に変更しました。
 *
 * @impact
 * - 会員登録画面の「電話番号」の行だけが、他の項目と比べて左のインデントがずれて表示されるようになります。
 *
 * @revert
 * - このFaRSeTコメントブロックを削除し、直下の`<div class="form-group">`内の`<form:label>`の`cssClass`を`col-md-3`から`col-md-4`に、続く`<div>`の`class`を`col-md-9`から`col-md-8`に戻してください。
 *
 ****************************************************************/
--%>
                            <div class="form-group">
                                <form:label path="tel1" cssClass="col-md-3 control-label">電話番号</form:label>
                                <div class="col-md-9 form-inline">
                                    <form:input path="tel1"
                                        cssClass="form-control form-control-separated"
                                        style="width: 5.5em" maxlength="5"
                                        data-parsley-required="true"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 form-inline">
                                    <form:input cssClass="form-control form-control-separated"
                                        path="zipCode1" style="width: 3.5em" maxlength="3"
                                        data-parsley-required="true"
                                    ...
                                    -
                                    <form:input cssClass="form-control form-control-separated"
                                        path="zipCode2" style="width: 4.5em" maxlength="4"
                                        data-parsley-required="true"
                                    ...
                                    <div class="clearfix"></div>
                                    <form:errors path="zipCode1" cssClass="invalid"
                                        element="span" />
                                    <form:errors path="zipCode2" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:input path="address" cssClass="form-control"
                                        maxlength="60" data-parsley-maxlength="60"
                                        data-parsley-required="true" />
                                    <form:errors path="address" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:input path="mail" cssClass="form-control"
                                        maxlength="256" data-parsley-maxlength="256"
                            ...
                            <div class="form-group">
                                <form:label path="reEnterMail"
                                    cssClass="col-md-4 control-label">Eメール再入力</form:label>
                                <div class="col-md-8">
                                    <form:input path="reEnterMail" cssClass="form-control"
                                        maxlength="256" data-parsley-maxlength="256"
                                        data-parsley-required="true" data-parsley-type="email"
                                        data-parsley-equalto="#mail"
                                        data-parsley-equalto-message="Eメールアドレスが一致しません。" />
                                    <form:errors path="reEnterMail" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>

                            <div class="form-group">
                                <form:label path="creditTypeCd"
                                    cssClass="col-md-4 control-label">クレジットカード会社</form:label>
                                <div class="col-md-8">
                                    <c:forEach var="item" items="${CL_CREDITTYPE}">
                                        <label class="radio-inline"> <form:radiobutton
                                                path="creditTypeCd" value="${f:h(item.key)}"
                                                data-parsley-required="true" />${f:h(CL_CREDITTYPE[item.key])}
                                        </label>
                                    </c:forEach>
                                    <div class="clearfix"></div>
                                    <form:errors path="creditTypeCd" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <form:input path="creditNo" cssClass="form-control"
                                        maxlength="16" data-parsley-required="true"
                                        data-parsley-type="integer" data-parsley-length="[16, 16]"
                                        data-parsley-length-message="%s 文字で入力してください。" />
                                    <form:errors path="creditNo" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>

                            <div class="form-group">
                                <form:label path="creditMonth"
                                    cssClass="col-md-4 control-label">クレジットカード有効期限</form:label>
                                <div class="col-md-8 form-inline">
                                    ...
                                    <div class="clearfix"></div>
                                    <form:errors path="creditMonth" cssClass="invalid"
                                        element="span" />
                                    <form:errors path="creditYear" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <form:label path="reEnterPassword"
                                    cssClass="col-md-4 control-label">パスワード再入力</form:label>
                                <div class="col-md-8">
                                    ...
                                    <form:errors path="reEnterPassword" cssClass="invalid"
                                        element="span" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-offset-4 col-md-8">
                                    <input type="submit"
                                        class="btn btn-primary btn-size-default" value="登録確認">
                                </div>
                            </div>
                        </form:form>
                    </div>
    ...
    <script
        src="${pageContext.request.contextPath}/resources/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/vendor/bootstrap-datepicker/js/locales/bootstrap-datepicker.ja.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/vendor/moment/min/moment.min.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/vendor/parsleyjs/parsley.min.js"></script>

    <script src="${pageContext.request.contextPath}/resources/js/atrs.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/js/parsley-config.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/js/parsley-validator-date.js"></script>
    <script
        src="${pageContext.request.contextPath}/resources/js/member-register-form.js"></script>
</body>
</html>